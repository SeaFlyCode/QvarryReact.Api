...
const MaintenanceSchema: Schema = new Schema({
    ...
    message: {
        type: String,
        default: "Le site est actuellement en maintenance. Nous serons bientôt de retour."
    },
    activatedBy: {
...
const MaintenanceModel = mongoose.model<IMaintenance>("Maintenance", MaintenanceSchema);
