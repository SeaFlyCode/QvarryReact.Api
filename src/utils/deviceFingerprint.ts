 ...
 * Utile pour détecter les sessions suspectes sans bloquer les utilisateurs légitimes
 */
export function compareFingerprints(fp1: string | undefined, fp2: string | undefined): boolean {
    if (!fp1 || !fp2) return true; // Pas de fingerprint = pas de comparaison
    return fp1 === fp2;
}
