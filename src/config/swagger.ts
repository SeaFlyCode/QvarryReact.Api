...
export const setupSwagger = (app: Express): void => {
    ...
    const refreshSwaggerSpec = (req: Request, res: Response, next: NextFunction) => {
    ...
    app.use('/api-docs',
        refreshSwaggerSpec,
        swaggerUi.serveFiles(undefined, { swaggerOptions: { url: '/api-docs.json' } }),
    ...
    console.log('🔄 Hot-reload activé : la documentation se met à jour automatiquement');
};
